...
class EMACrossoverRSI:
    ...
    def add_distance_between_ema12_close(self):
        self.df['distance'] = self.df['12ema'] - self.close
    ...
    def determine_signal(self, dframe):
        ...
        if (ema6.iloc[-1] < ema12.iloc[-1]) and (
    ...
    def plot_graph(self):
        ...
        visualisation.plot_graph("EMA Crossover with RSI Strategy Alternative")
