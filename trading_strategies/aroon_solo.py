...
class Aroon:
    ...
    def __init__(self, file_path):
        self.max_window = 100 # set to 100 to clearly see indicator working
    ...
    def determine_signal(self, dframe):
        ...
        # A buy entry signal is given when aroon up > 50 and aroon down < 50
        dframe.loc[((((dframe['aroon_up'] > 50) & (dframe['aroon_down'] < 50)) | ((dframe['aroon_up'].shift(1) > 50) & (dframe['aroon_down'].shift(1) < 50))
                      ...
                      | ((dframe['aroon_up'].shift(4) > 50) & (dframe['aroon_down'].shift(4) < 50)))), 'signal'] = 1


        # A sell entry signal is given when aroon down > 50 and aroon up < 50
        dframe.loc[( (((dframe['aroon_down'] > 50) & (dframe['aroon_up'] < 50)) | ((dframe['aroon_down'].shift(1) > 50) & (dframe['aroon_up'].shift(1) < 50))
                       ...
                       | ((dframe['aroon_down'].shift(4) > 50) & (dframe['aroon_up'].shift(4) < 50)))), 'signal'] = -1
    ...
    def plot_graph(self):
        ...
        visualisation.add_subplot(plot_df['aroon_up'], panel=1, color="blue", ylabel="Aroon Up")
        visualisation.add_subplot(plot_df['aroon_down'], panel=1, color="pink", ylabel="Aroon Up")

        # create final plot with title
        visualisation.plot_graph("Aroon Indicator Strategy")
